...
describe AppointmentsController do
  ...
  def valid_attributes
    { "start_time" => "2013-03-13 17:38:02" }
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested appointment" do
        ...
        Appointment.any_instance.should_receive(:update_attributes).with({ "start_time" => "2013-03-13 17:38:02" })
        put :update, {:id => appointment.to_param, :appointment => { "start_time" => "2013-03-13 17:38:02" }}, valid_session
      end
